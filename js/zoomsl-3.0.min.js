...
(function (e) {
    ...
    e.extend(y, {
        dsetting: {
            ...
            classtextdn: "textdn"
        }, U: -1 != navigator.userAgent.indexOf("MSIE") ? k : r, T: function (d) {
            var c = 0, a;
            ...
            if (a) {
                ...
                }), a.s.css({left: c.a.p - Math.round(a.e.b / 2), top: c.a.q + a.e.d / 2}));
            ...
            (h = l.left, b = l.top, c = function () {
                ...
                a.s.css({left: h, top: b + p}).stop(k, k).fadeIn(a.c.magnifierspeedanimate)
            });
            ...
            function s(a) {
                g.data("specs", {
                    ...
                    w: {
                        b: q.width(),
                        d: q.height(),
                        t: {N: parseInt(q.css("border-left-width")) || 0, R: parseInt(q.css("border-top-width")) || 0}
                    },
                    h: B,
                    k: B
                })
            ...
            var b = e.extend({}, this.dsetting, c), x = b.zindex || this.T(d), m = {b: d.width(), d: d.height()},
                p = new p, y = d.attr("data-title") ? d.attr("data-title") : "",
            ...
            if (0 === m.d || 0 === m.b) e(new Image).load(function () {
                ...
                e.event.special.mousewheel = {
                    setup: function () {
                        ...
                        if (this.removeEventListener) for (var a = A.length; a;) this.removeEventListener(A[--a], h, r); else this.onmousewheel = null
                    }
                };
                e.fn.offsetsl = function () {
                    var a = this.get(0);
                    if (a.getBoundingClientRect) a = this.offset(); else {
                ...
                g.one("mouseover", function () {
                    var a = d.offsetsl(),
                        h = e('<img src="' + b.j + '"/>').css({position: "relative", maxWidth: "none"}).appendTo(u);
                    f.O[b.j] || (g.css({
